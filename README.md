...
git clone https://github.com/YOUR-USERNAME/jarvis-mini.git
cd jarvis-mini
pip install -r requirements.txt
For local AI chat, install Ollama and pull a model:
...
Python 3
Ollama (local AI)
Standard libraries + [any libraries you used, e.g. requests, colorama...]
📌 Why Jarvis Mini?
